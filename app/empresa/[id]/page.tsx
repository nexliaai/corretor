...
import { ArrowLeft, Building2, Mail, Phone, MapPin, FileText, Car, Loader2 } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-6">
          <div className="flex items-start gap-6">
            <div className="p-6 bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl">
            ...
            <div className="flex-1">
              ...
              {empresa.nome_fantasia && (
                <p className="text-gray-600 mb-4">{empresa.razao_social}</p>
              )}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex items-center gap-3 text-gray-700">
                  ...
                  <div>
                    ...
                    <div className="font-semibold">{formatDocument(empresa.cnpj)}</div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 text-gray-700">
                  ...
                  <div>
                    ...
                    <div className="font-semibold">{empresa.email_principal || '-'}</div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 text-gray-700">
                  ...
                  <div>
                    ...
                    <div className="font-semibold">{empresa.telefone_principal || '-'}</div>
                  </div>
                </div>
              ...
              {empresa.ramo_atividade && (
                <div className="mt-4 pt-4 border-t border-gray-200">
                  <div className="text-sm text-gray-500 mb-1">Ramo de Atividade</div>
                  <div className="text-gray-900">{empresa.ramo_atividade}</div>
                </div>
              )}
            </div>
          </div>
